    ...
    texts.selectAll("text")
     ...
     function selectArtists(time, artistNum){
        ...
        linesOne.enter().append("path")
            ...
            // .attr("stroke","#70c1b3")
            .attr("stroke", (d, i) => {
                if (d.source.name == lineTwoLinks[i].target.name){
                    return gradientColor(+lineTwoLinks[i].target.number)
                } 
            })
        ...
        linesTwo.enter().append("path")
            ...
            .attr("stroke-linecap", "round")
            // .attr("stroke","#70c1b3")
            .attr("stroke", d => gradientColor(+d.target.number))
            .transition().duration(time)
            .attr("opacity", 1)
        ...
        linesThree.enter().append("path")
            ...
            .attr("stroke-linecap", "round")
            .attr("stroke","#70c1b3")
            .attr("stroke", d => gradientColor(+d.source.number))
            .transition().duration(time)
            .attr("opacity", 1)
